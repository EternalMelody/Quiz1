...
public class DS4
{
    ...
    public static ButtonControl acclY2 = null;
    ...
    public static Gamepad getConroller(string layoutFile = null)
    {
        ...
        string layout = File.ReadAllText(layoutFile == null ? "Assets/customLayout.json" : layoutFile);

        // Overwrite the default layout
        InputSystem.RegisterLayoutOverride(layout, "DualShock4CustomGamepadHID");
    ...
    private static void bindControls(Gamepad ds4)
    {
        ...
        acclY2 = ds4.GetChildControl<ButtonControl>("accl Y 21");
    ...
    public static Vector3 getAcceleration(float scale = 1f)
    {
